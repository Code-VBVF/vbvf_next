  ...
  return (
    <div className={styles.disclosures}>
      ...
      <ul>
        ...
        <li>
          What choices you have regarding collection, use and distribution of
          your information;
        </li>
        <li>
        ...
        <li>How you can correct any inaccuracies in you information;</li>
      </ul>
      <p>
      ...
      <ul>
        <li>
          Some areas of our Site request or require contact and other
          information.
        </li>
        <li>
      ...
      <p>
        ...
        If requested to remove data, we will respond within a reasonable time
        frame.
      </p>
      <h2>SECURITY</h2>
      <p>
