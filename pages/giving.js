...
export default function Giving(props) {
  ...
  return (
    <div className={styles.giving}>
      <div className={styles.givingDesc}>
      ...
      <div className={styles.givingOptionQuestion}>
        ...
        <div className={styles.givingOptionQuestionIcons}>
          <div
            onClick={onlineModalToggle}
            className={styles.givingOptionQuestionIconsOption}
          >
            ...
            <Modal isOpen={onlineModal} toggle={onlineModalToggle} size="lg">
              ...
              <ModalBody>
                <div className={styles.givingVideo}>
                  <iframe
                    title="Giving Online"
          ...
          >
            ...
            <Modal isOpen={mailModal} toggle={mailModalToggle} size="lg">
              ...
              <ModalBody>
                ...
                <span
                  className={
                    styles.givingOptionQuestionIconsOptionMailingAddress
                  }
                >
